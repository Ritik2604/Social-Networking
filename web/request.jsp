...
<div style="position: absolute; width: 201px; height: 157px; z-index: 1; left: 255px; top: 12px; bottom: 155px;" id="layer2">
	<img src="<%=session.getAttribute("img")%>" height="79">
            <br>
                
</div>
<div style="position: absolute; width: 211px; height: 327px; z-index: 2; left: 252px; top: 244px" id="layer3">
...
<div style="position: absolute; width: 893px; height: 546px; z-index: 3; left: 486px; top: 14px" id="layer4" class="style2">
	REQUEST SENT SUCCESSFULLY<br>
	<br>
	<a href="searchfrd.jsp">BACK</a></div>
</div>

<div style="position: absolute; width: 203px; height: 54px; z-index: 2; left: 251px; top: 672px" id="layer5" class="style1">
