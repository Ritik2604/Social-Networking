...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="en-US" xml:lang="en">
    ...
    <body>
        ...
        <div style="position: absolute; width: 1392px; height: 324px; z-index: 1; left: 0px; top: 496px" id="layer1">
            <div style="position: absolute; width: 215px; height: 157px; z-index: 1; left: 196px; top: 14px; bottom: 153px;" id="layer2">
                <img src="<%=session.getAttribute("img")%>" height="119" width="166">
                    <br>

                        </div>
                        <div style="position: absolute; width: 211px; height: 327px; z-index: 2; left: 190px; top: 256px" id="layer3">
                                                                                    ...
                                                                                    <br>
                                                                                        ...
                                                                                        <%
                                                                                            try {
                                                                                                ...
                                                                                                if (rs.next()) {
                                                                                        %>
                                                                                        <div style="position: absolute; width: 951px; height: 546px; z-index: 3; left: 422px; top: 14px" id="layer4">
                                                                                                ...
                                                                                                <table style="width: 66%">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td style="width: 287px" class="style2">
                                                                                                                    ...
                                                                                                                    <a href="accept.jsp?fid=<%=fid%>&sno=<%=request.getParameter("sno")%>">ACCEPT</a></td>
                                                                                                        <td style="width: 267px">&nbsp;</td>
                                                                                                        <td><a href="reject.jsp?sno=<%=request.getParameter("sno")%>">REJECT</a></td>
                                                                                                    </tr>
                                                                                                </table>
                                                                                          
                                                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
																								<div style="position: absolute; width: 195px; height: 177px; z-index: 1; left: 715px; top: 19px" id="layer6">
																									<img src="<%=request.getParameter("img")%>" width="135" height="137"><%=fid%></div>
                                                                                        ...
                                                                                        %>
                                                                                        <div style="position: absolute; width: 203px; height: 54px; z-index: 2; left: 197px; top: 677px" id="layer5" class="style1">
