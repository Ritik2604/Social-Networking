...
<div style="position: absolute; width: 201px; height: 157px; z-index: 1; left: 228px; top: 12px; bottom: 155px;" id="layer2">
	<img src="<%=session.getAttribute("img")%>" height="79">
            <br>
                
</div>
<div style="position: absolute; width: 211px; height: 327px; z-index: 2; left: 217px; top: 244px" id="layer3">
	...
	<br>
            ...
            <%
                ...
                new DB().update("insert into tbfriend values("+new DB().generateID()+",'"+request.getParameter("fid")+"','"+(String)session.getAttribute("uid")+"',1)");
...
<div style="position: absolute; width: 928px; height: 546px; z-index: 3; left: 445px; top: 14px" id="layer4" class="style2">
	<strong>YOU ARE NOW FRIENDS</strong></div>
</div>

<div style="position: absolute; width: 203px; height: 54px; z-index: 2; left: 223px; top: 674px" id="layer5" class="style1">
