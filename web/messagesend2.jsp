...
<div style="position: absolute; width: 201px; height: 157px; z-index: 1; left: 236px; top: 16px; bottom: 151px;" id="layer2">
	<img src="<%=session.getAttribute("img")%>" height="140" width="151">
            <br>
                
</div>
<div style="position: absolute; width: 211px; height: 327px; z-index: 2; left: 228px; top: 250px" id="layer3">
...
<div style="position: absolute; width: 870px; height: 546px; z-index: 3; left: 503px; top: 14px" id="layer4">
    <%
        try{
...
<a href=messagesend.jsp?fid=<%=session.getAttribute("fid")%>>SEND AGAIN</a>
</div>
</div>

<div style="position: absolute; width: 203px; height: 54px; z-index: 2; left: 230px; top: 682px" id="layer5" class="style1">
